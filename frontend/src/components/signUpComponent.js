  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center animate-appearing">
      ...
      <div className="lg:w-1/4 md:w-1/3 w-3/5 px-6 flex flex-col grow justify-center items-center">
        ...
        {signUp.isError ? (
          <div className="text-red-300 py-2">{signUp.error.message}</div>
        ) : null}
        <InputComponent
          key="usernameField"
        ...
        <InputComponent
          ...
          inputProps={{
            ...
            type: "password",
            id: "password",
            autoComplete: state.isSignIn ? "current-password" : "new-password",
          }}
          icon={<BiShield />}
        />
        {!state.isSignIn ? (
          ...
          <span className="cursor-default">
            {state.isSignIn ? (
              <>
                ...
                <span className="text-mainColor" onClick={setIsSignUp}>
                  Sign Up
                </span>
              </>
            ) : (
              <>
                {"Already registered? "}
                <span className="text-mainColor" onClick={setIsSignIn}>
                  Sign In
                </span>
              </>
            )}
